...
public class OperacionController {
	...
	public String sumarUsa(@RequestParam float a, @RequestParam float b) {
		...
		return clienteRest.getForObject("https://resultados-sd-usa.herokuapp.com/resultado/" + resultado, String.class);
	}
	...
	public String sumarEu(@RequestParam float a, @RequestParam float b) {
		...
		return clienteRest.getForObject("https://resultados-sd-eu.herokuapp.com/resultado/" + resultado, String.class);
	}
